...
public class UserRemarkController {
    ...
    @GetMapping("/page")
    public Response<Page<UserRemarkDto>> getPage(@Validated UserRemarkQueryDto queryDto, Page page) {
        Page<UserRemarkDto> result = userRemarkService.queryPage(page, QueryUtil.bulid(queryDto));
